...
public class LessThanStrict implements Constraint {
    /* Constraint of order : a is strictily less than  b (a < b) */ 
    private Variable var1;
    private Variable var2;
    private String name; 
    
    // constructeur
    public LessThanStrict(Variable var1, Variable var2, String name){
        this.var1 = var1;
        this.var2 = var2;
        this.name = name; 
    }
